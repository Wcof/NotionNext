...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Wcof', // 您的昵称 例如 Wcof
  BIO: process.env.NEXT_PUBLIC_BIO || ' 一个互联网牛马', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://wcof.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, Wcof', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个产品经理, Hi，我是一个牛马,Hi，我是一个傻逼,欢迎来到我的博客🎉',
